<template>
    <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#exportModal">Export Transfers</button>
    ...
    export default {
        ...
        methods: {
            requestReport() {
                ...
                axios.post(this.getDomain('business/' + Business.id + '/payment-provider/paynow/payout/export', 'dashboard'), {
