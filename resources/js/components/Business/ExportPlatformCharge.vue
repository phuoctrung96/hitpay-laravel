<template>
    <div>
        <button v-if="exportEnabled()" class="btn btn-primary" data-toggle="modal" data-target="#exportModal">Export</button>
    ...
    export default {
        ...
        methods: {
            ...
            requestReport() {
                ...
                axios.post(this.getDomain('business/' + Business.id + '/platform/charge/export', 'dashboard'), {
