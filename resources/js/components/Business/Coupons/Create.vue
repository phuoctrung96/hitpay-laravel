            ...
            <div class="card-body border-top">
                <form id="business-discount" ref="businessCoupon">
                    ...
                    <div class="form-group">
                      ...
                      <span class="invalid-feedback d-block" role="alert" v-if="errors.coupon_type">{{ errors.coupon_type }}</span>
                    </div>
        ...
        methods: {
            createCoupon(){
                ...
                if (Object.keys(this.errors).length > 0) {
                    ...
                    axios.post(this.getDomain('v1/business/' + Business.id + '/coupon', 'api'), this.form,{
