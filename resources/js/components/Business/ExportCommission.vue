<template>
    <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#exportModal">Export Commission Payouts</button>
    ...
    export default {
        ...
        methods: {
            requestReport() {
                ...
                axios.post(this.getDomain('business/' + Business.id + '/platform/payout/export', 'dashboard'), {
