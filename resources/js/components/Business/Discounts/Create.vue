            ...
            createDiscount(){
                ...
                if (this.form.discount_type === this.promotion_type_specific_categories) {
                  ...
                  if (this.form.applies_to_ids.length === 0) {
                    this.errors.added_categories = 'Please choose any category';
                  }
                }
                ...
                if (this.form.discount_type === this.promotion_type_specific_products) {
                  ...
                  if (this.form.applies_to_ids.length === 0) {
                    this.errors.added_products = 'Please choose any product';
                  }
                }
                ...
                if (Object.keys(this.errors).length > 0) {
                    ...
                    axios.post(this.getDomain('v1/business/' + Business.id + '/discount', 'api'), this.form, {
