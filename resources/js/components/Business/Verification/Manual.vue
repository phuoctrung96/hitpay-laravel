    ...
    <div class="account-verification">
        <div class="card">
            <div class="row no-gutters justify-content-center">
                    ...
                    <div class="card-body align-self-start">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control" id="uen" v-model="verification.uen"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="entity_type" v-model="verification.entity_type"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select class="form-control" id="entity_status" v-model="verification.entity_status"
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <textarea class="form-control" id="primary_activity" v-model="verification.primary_activity"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <button
                                    v-if="verification.shareholders.length < 10"
                                    ...
                                    <div v-for="(shareholder, key) in verification.shareholders" class="form-group p-4 mt-2 border">
                                        <div class="form-row" :id="`shareholder_${key}`">
                                            <div class="form-group col-md-12">
                                                ...
                                                <span class="btn-delete ml-3"><img src="/images/delete_icon.svg" alt="delete"></span>
                                            </div>
                                        </div>
                ...
                <div class="form-check mb-3 col-12 text-center">
                    <input
...
export default {
    ...
    methods: {
        ...
        resetShareHolderError() {
            for (let i=0; i<this.verification.shareholders_count; i++) {
            ...
            this.verification.shareholders_is_owner.forEach((value, keyIndex) => {
                if (value === 'yes') {
                    ...
                    if (typeof this.verification.shareholders_email[keyIndex] !== 'undefined') {
                        ...
                        if (email !== "" && email.trim() !== "") {
                            this.isOwnerHasEmail = /\S+@\S+\.\S+/.test(this.verification.shareholders_email[keyIndex]);
                        }
        ...
        saveVerification() {
            ...
            // set nric name
            let nric = this.form_names[this.business.country].nric;
            ...
            if (this.$refs.supporting_documents) {
                for (let i = 0; i < this.$refs.supporting_documents.files.length; i++) {
            ...
            let path = 'business/' + this.business.id + '/verification/manual';
