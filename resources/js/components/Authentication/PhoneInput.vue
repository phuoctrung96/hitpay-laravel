    ...
    <div
        ...
        <div class="input-group">
            <div class="input-group-prepend">
                <select v-model="chosenCountryCode" class="form-control select-code" id="code-select">
            ...
            <input
                :value="value"
                @input="$emit('phoneInput', $event, $event.target.value, chosenCountryCode)"
                :type="type"
                class="form-control"
