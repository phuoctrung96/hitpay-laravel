<template>
    <div class="mt-3">
        <button class="btn btn-primary" data-toggle="modal" data-target="#exportReferralFeesModal">Export Referral Fees</button>
        <div class="modal fade" id="exportReferralFeesModal" tabindex="-1" role="dialog" aria-labelledby="exportModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exportModalLabel">Export Referral Fees</h5>
...
<script>
export default {
    name: "ExportBusinessReferralFees",
    data() {
        return {
            error: null,
            modal: null,
    ...
    mounted() {
        this.modal = $('#exportReferralFeesModal');
    ...
    methods: {
        requestReport() {
            ...
            let url = this.getDomain('referral-fees/export', 'admin')
