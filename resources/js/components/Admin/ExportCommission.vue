<template>
    <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#exportModal">Export Commissions</button>
    ...
    export default {
        ...
        methods: {
            requestReport() {
                ...
                if (Business !== null) {
                    url = this.getDomain('business/' + Business.id + '/commission/export', 'admin');
                } else {
                    url = this.getDomain('commission/export', 'admin')
                }
