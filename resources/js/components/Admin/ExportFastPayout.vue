<template>
    <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#exportModal">Export Fast Payouts</button>
    ...
    export default {
        ...
        methods: {
            requestReport() {
                ...
                if (Business !== null) {
                    url = this.getDomain('business/' + Business.id + '/transfer/fast-payment/export', 'admin');
                } else {
                    url = this.getDomain('transfer/fast-payment/export', 'admin')
                }
