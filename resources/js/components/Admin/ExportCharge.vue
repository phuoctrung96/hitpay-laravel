<template>
    <div>
        <button class="btn btn-primary" data-toggle="modal" data-target="#exportModal">Export Charges</button>
...
export default {
    ...
    methods: {
        requestReport() {
            ...
            if (Business !== null) {
                url = this.getDomain('business/' + Business.id + '/charge/export', 'admin');
            } else {
                url = this.getDomain('charge/export', 'admin')
            }
