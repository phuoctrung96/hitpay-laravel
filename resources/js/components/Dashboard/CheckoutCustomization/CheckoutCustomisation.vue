  ...
  <div class="checkout-customisation d-flex justify-content-center">
    <div class="d-flex flex-column ">
      <div class="dashboard-card d-flex flex-column align-items-start">
        ...
        <div class="d-flex flex-column flex-lg-row justify-content-center mt-2 w-100">
          <ThemePreview
      ...
      <AdminFees
        ...
        :adminFeeOptions="customisation.admin_fee_settings"
        :channels="channels"
        @changed="changedFees = $event"
        />
      ...
      <div class="dashboard-card d-flex flex-column align-items-start mt-4">
        ...
        <div class="d-flex flex-column mt-2 align-items-center w-100">
          <div
            ...
            :key="index"
            class="d-flex align-items-start justify-content-between mb-4 flex-column-reverse flex-lg-row rule-row">
            ...
            <div class="d-flex flex-row flex-lg-column justify-content-between h-100">
          ...
          <div class="d-flex align-items-start justify-content-between flex-column-reverse flex-lg-row rule-row">
            <div class="d-flex flex-column first-column">
...
export default {
  ...
  mounted () {
    ...
    window.onbeforeunload = () => {
        if (this.changedTheme || this.changedFees || this.changedMethodOrder || this.changedRules) {
