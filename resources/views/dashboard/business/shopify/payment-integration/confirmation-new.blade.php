        ...
        <div class="col-md-9 col-lg-8 main-content">
            <div class="card shadow-sm mb-3">
                <div class="card-body p-4">
                    ...
                    <p>Your HitPay account will be connecting to the Shopify store and and it will be added as a payment app. If you want to stop using this app or want to connect to another shopify account, you may uninstall the app from your Shopify dashboard.
                    </p>
                </div>
