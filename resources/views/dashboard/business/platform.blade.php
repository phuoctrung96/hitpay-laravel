...
@section('business-content')
    ...
    <div class="row">
        <div class="col-12 col-md-9 col-lg-8 mb-4">
            <a href="{{ route('dashboard.business.home', $business->getKey()) }}">
                <i class="fas fa-reply fa-fw mr-3"></i> Back to {{ $business->getName() }}</a>
        </div>
        <div class="col-md-9 col-lg-8 main-content">
            <div class="form-group">
                <form class="input-group input-group-lg" action="{{ route('dashboard.business.platform.index', [
                    $business->getKey(),
                ]) }}">
            ...
            <div class="card border-0 shadow-sm mb-3">
                <div class="card-body p-4">
                    ...
                    @if ($business->platform_enabled)
                        ...
                        <hr>
                        <form action="{{ route('dashboard.business.platform.update', [
                            $business->getKey(),
                        ]) }}" method="post">
                            @csrf
                            @method('put')
                            ...
                            <div class="input-group mb-3">
                                <input class="form-control {{ $errors->has('rate') ? 'is-invalid' : '' }} bg-light" title="Commission Rate" name="rate" value="{{ bcmul($business->commission_rate, 100, 2) }}">
                                <div class="input-group-append">
        ...
        <div class="col-md-3 col-lg-4">
            <business-platform-charge-export
                :current_business_user="{{ json_encode($currentBusinessUser) }}"></business-platform-charge-export>
        </div>
    </div>
@endsection
