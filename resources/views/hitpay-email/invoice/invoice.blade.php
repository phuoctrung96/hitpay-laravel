    ...
    <tr>
        ...
        <td class="container" style="{{ $style['outer_td'] }} {{ $style['outer_td_ext'] }}" width="580" valign="top">
            <div class="content" style="{{ $style['content'] }}">
                <span class="preheader" style="{{ $style['preheader'] }}">Invoice from {{ $business_name }}.</span>
                        ...
                        <tr>
                            <td class="align-center" style="{{ $style['outer_td'] }} text-align: center;" valign="top"
                                ...
                                @if (isset($business_logo))
                                    <img src="{{ $business_logo }}" height="48" alt="Logo" align="center"
                                         style="{{ $style['img'] }}">
                                @endif
                                <h1>{{ $business_name }}</h1>
                            </td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="main" style="{{ $style['out_table'] }}"
                       width="100%">
                    <tr>
                        <td class="wrapper" style="{{ $style['outer_td'] }} box-sizing: border-box; padding: 20px;"
                            valign="top">
                                ...
                                <tr>
                                    <td style="{{ $style['outer_td'] }}" valign="top">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"
                                               style="{{ $style['special_1'] }}"
                                               width="100%">
                                            <tr>
                                                <td style="{{ $style['outer_td'] }}" valign="top">&nbsp;</td>
                                                <td class="receipt-container"
                                                    style="{{ $style['outer_td'] }} width: 80%;"
                                                    width="80%" valign="top">
                                                    <table class="receipt" border="0" cellpadding="0" cellspacing="0"
                                                           style="{{ $style['innest_table'] }}" width="100%">
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Reference
                                                            </td>
                                                            <td class="receipt-figure"
                                                                style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">{{ $reference }}</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Invoice
                                                                Number
                                                            </td>
                                                            <td class="receipt-figure"
                                                                style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">{{ $invoice_number }}</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Invoice Id
                                                                #
                                                            </td>
                                                            <td class="receipt-figure"
                                                                style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">{{ $invoice_id }}</td>
                                                        </tr>
                                                        @if ($due_date)
                                                            <tr class="receipt-bold">
                                                                <td style="{{ $style['details'] }}" valign="top">Due
                                                                    Date
                                                                </td>
                                                                <td class="receipt-figure"
                                                                    style="{{ $style['details'] }} font-weight: 600;"
                                                                    valign="top" align="right">{{ $due_date }}</td>
                                                            </tr>
                                                        @endif
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Customer
                                                                Name
                                                            </td>
                                                            <td class="receipt-figure"
                                                                style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top"
                                                                align="right">{{ $customer['name'] ?? '-' }}</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Customer
                                                                Email
                                                            ...
                                                            <td class="receipt-figure"
                                                                style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top"
                                                                align="right">{{ $customer['email'] ?? '-' }}</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Amount
                                                                Due
                                                            </td>
                                                            <td class="receipt-figure"
                                                                style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">{{ $amount }}</td>
                                                        </tr>
                                                        @if($products)
                                                            <tr class="receipt-bold">
                                                                <td style="{{ $style['details'] }}" valign="top">Products
                                                                </td>
                                                                <td class="receipt-figure"
                                                                    style="{{ $style['details'] }} font-weight: 600;"
                                                            ...
                                                            @foreach($products as $item)
                                                                <tr>
                                                                    <td valign="top">{{$item['product']['name']}} {{$item['variation']['description'] ? $item['variation']['description'] : ''}}
                                                                    </td>
                                                                    <td valign="top" align="right">Quantity: {{$item['quantity']}}</td>
                                                                </tr>
                                                            @endforeach
                                                        @endif
                                                    </table>
                                                    <p style="text-align: center; margin: 0; margin-bottom: 30px; margin-top: 30px; color: #fff !important;">
                                                        <a href="{{ $hosted_link }}" bgcolor="#000036" style="display: inline-block; font-weight: 400; color: #fff !important; background-color: #28a745 !important; text-decoration: none !important; border-color: #28a745; text-align: center; vertical-align: middle; border: 1px solid transparent; padding: .375rem .75rem; font-size: 1rem; line-height: 1.5; border-radius: .25rem;">View invoice</a>
                                                    </p>

                                                <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">
                                                        If you have any questions about this invoice, please contact <a
                                                            href="mailto:{{ $business_email }}" target="_blank"
                                                            style="color: #3498db; text-decoration: underline;">{{ $business_email }}</a>
                                                    </p>
                                                </td>
                                                <td style="{{ $style['outer_td'] }}" valign="top">&nbsp;</td>
                                            </tr>
                                        ...
                                        <h6 style="color: #222222; font-family: sans-serif; font-weight: 300; line-height: 1.4; margin: 0; Margin-bottom: 30px; font-size: 14px; text-transform: capitalize; text-align: center">
                                            Powered by HitPay</h6>
                                        <p class="align-center" style="text-align: center;" valign="top" align="center">
                                            <img src="{{ asset('hitpay/logo-000036.png') }}" height="48" alt="Logo"
                                                 align="center" style="{{ $style['img'] }}">
                                        </p>
                                    </td>
                                </tr>
                            </table>
