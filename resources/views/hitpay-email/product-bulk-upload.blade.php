...
@section('content')
    <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
        ...
        <p style="color: #222222; font-family: sans-serif; font-weight: 300; line-height: 1.4; margin: 0; Margin-bottom: 30px; font-size: 24px; text-align: center; text-transform: capitalize;">
            {{ $messageText }}
        </p>
            ...
            <tr>
                ...
                <td class="receipt-container" style="font-family: sans-serif; font-size: 14px; vertical-align: top; width: 80%;" width="80%" valign="top">
                    @foreach ($errors as $key => $error)
                        @if($key =='sku')
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">{{ $error.', please check all product items has a unique SKU'}}</p>
                        @else
