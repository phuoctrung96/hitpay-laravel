                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="{{ $style['special_1'] }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="receipt-container" style="{{ $style['outer_td'] }} width: 80%;"
                                                    ...
                                                    @else
                                                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">The customer’s direct debit auhtorization for the below plan has failed to charge. The customer has been notified about the failed charged by email.</p>
                                                    @endif
