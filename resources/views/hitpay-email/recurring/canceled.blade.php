                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="{{ $style['special_1'] }}" width="100%">
                                <tr>
                                    <td style="{{ $style['outer_td'] }}" valign="top">
                                        <h1 style="color: #222222; font-family: sans-serif; font-weight: 300; line-height: 1.4; margin: 0; Margin-bottom: 30px; font-size: 25px; text-transform: capitalize; text-align: center">{{ $business_name }} has cancelled {{ $plan_name }} with immediate effect.</h1>
                                        <table border="0" cellpadding="0" cellspacing="0" style="{{ $style['special_1'] }}"
                                            ...
                                            <tr>
                                                ...
                                                <td class="receipt-container" style="{{ $style['outer_td'] }} width: 80%;"
                                                    ...
                                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">If you have any questions about this cancellation, please contact <a href="mailto:{{ $business_email }}" target="_blank" style="color: #3498db; text-decoration: underline;">{{ $business_email }}</a></p>
                                                </td>
                                                <td style="{{ $style['outer_td'] }}" valign="top">&nbsp;</td>
                                            </tr>
                                        </table>
