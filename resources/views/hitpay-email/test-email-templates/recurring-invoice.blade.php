                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="{{ $style['special_1'] }}" width="100%">
                                <tr>
                                    <td style="{{ $style['outer_td'] }}" valign="top">
                                        <h1 style="color: #222222; font-family: sans-serif; font-weight: 300; line-height: 1.4; margin: 0; Margin-bottom: 30px; font-size: 25px; text-transform: capitalize; text-align: center">{{ $subtitle }}</h1>
                                                    ...
                                                    <table class="receipt" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr class="receipt-bold">
                                                            ...
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">Apple Subscription</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Recurring Plan #</td>
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">5512-1234-2344-2123</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Start Date</td>
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">11.06.2022</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                        ...
                                                        <tr class="receipt-bold">
                                                            ...
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">Anna</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Customer Email</td>
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">anna@outlook.com</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Billing Cycle</td>
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">Weekly</td>
                                                        </tr>
                                                        <tr class="receipt-bold">
                                                            <td style="{{ $style['details'] }}" valign="top">Amount Due</td>
                                                            <td class="receipt-figure" style="{{ $style['details'] }} font-weight: 600;"
                                                                valign="top" align="right">SGD 100.00</td>
                                                        </tr>
                                                    </table>

                                                    <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; Margin: 0; Margin-bottom: 15px;">
                                                        <a href="#" style="background-color: {{ $button_background_color }}; font-size: 14px; font-family: Helvetica, Arial, sans-serif; font-weight: bold; text-decoration: none; padding: 10px 16px; color: {{ $button_text_color }}; border-radius: 5px; display: inline-block; mso-padding-alt: 0;">
                                                            {{ $button_text }}
                                                        </a>
                                                    </p>
