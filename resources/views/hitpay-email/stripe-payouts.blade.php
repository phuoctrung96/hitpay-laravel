...
@section('content')
    ...
    <p style="font-family: monospace">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : {{ $bankAccount->account_holder_name ?? $transfer->business->name }}</p>
    <p style="font-family: monospace">Bank&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : {{ $bankAccount->bank_name ?? 'Not Recorded' }}</p>
    <p style="font-family: monospace">Account No : {{ isset($bankAccount->last4) ? "****{$bankAccount->last4}" : 'Not Recorded' }}</p>
    <br>
