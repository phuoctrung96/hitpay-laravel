...
@section('content')
    ...
    <p>Thank you for choosing HitPay as your payment acceptance partner for your business.
        This email is to inform you that a HitPay Payouts has been transferred into your bank account.
        Please find the following for the payout details.</p>
    <br>
    <p style="font-weight: bold">Receiver Details</p>
    <p style="font-family: monospace">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :
        {{ $bankAccount->holder_name ?? $transfer->business->name }}</p>
    <p style="font-family: monospace">Bank&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : {{ $bankName }}</p>
    <p style="font-family: monospace">Account No : {{ $bankAccount->number }}</p>
    <br>
