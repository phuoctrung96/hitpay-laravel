...
class SupportedCurrencyCode extends Enumeration
{
    ...
    {
        return in_array($value, self::zeroDecimal());
    }

    /**
     * Get zero-decimal currency list.
     *
     * @return array
     * @throws \ReflectionException
     */
    public static function zeroDecimal()
    {
        return [
            self::BIF,
            self::CLP,
    ...
    {
        return in_array($value, self::normal());
    }

    /**
     * Get normal currency list.
     *
     * @return array
     * @throws \ReflectionException
     */
    ...
    {
        return self::listConstants(self::zeroDecimal());
    }
}
