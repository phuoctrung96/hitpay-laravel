...
class Coupon extends Model implements OwnableContract
{
    ...
    protected $fillable = [
        'fixed_amount', 'percentage', 'name', 'code', 'is_promo_banner', 'coupons_left', 'banner_text',
        'coupon_type',
    ];
    ...
    {
        if ($this->coupon_type === PromotionAppliesToType::SPECIFIC_PRODUCTS) {
        ...
        } else if ($this->coupon_type === PromotionAppliesToType::SPECIFIC_CATEGORIES) {
