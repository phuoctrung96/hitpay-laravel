...
class SendExportedRefundsToAdmin implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if ($this->data['type'] == 'autorefunds') {
            unset($data['--request']);
            Artisan::call('export:charges.auto-refunds', $data);
        } else {
            Artisan::call('admin:daily-email', $data);
        }
    }
