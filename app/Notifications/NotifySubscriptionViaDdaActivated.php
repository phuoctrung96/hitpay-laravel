...
class NotifySubscriptionViaDdaActivated extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $title .= 'Recurring Billing Plan Activated : '.$notifiable->business->getName();

        return (new MailMessage)->view('hitpay-email.recurring.dda-activated', [
            'title' => $title,
