...
class NotifyOrderRefunded extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)->view('hitpay-email.buyer-order-refunded', [
                ...
                'refunded_date' => $this->order->closed_at->toDateTimeString(),
            ...
            ] + ($shipping ?? []) + ($application ?? []))->subject($prefix.'Your order has been refunded');
    }
}
