...
class NotifyAdminBusinessReferralFeesExport extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $title = "Exported Referral Fees for Admin";
        $content = "Attached is the exported csv of referral fees ({$this->period}) generated at {$this->datetime->toDateTimeLocalString()}.";
