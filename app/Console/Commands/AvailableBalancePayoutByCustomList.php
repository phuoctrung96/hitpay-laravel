...
class AvailableBalancePayoutByCustomList extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'hitpay:available-balance-payout-by-custom-list';
     ...
     * @var string
     */
    protected $description = 'Payout available balance by custom list';
    ...
    {
        $filename = "custom-requests/payout-by-business-ids.txt";
        ...
        $query->whereIn($query->qualifyColumn('id'), $lines);
        ...
        if ($time === '00:00:00') {
            ...
            $today = Date::createFromFormat('Y-m-d', $date);
