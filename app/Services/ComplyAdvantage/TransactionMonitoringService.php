            ...
            $response = $client->post('v2/transactions', [
                'body' => json_encode([
                    ...
                    'data' => [
                        ...
                        'tx_base_amount' => Conversion::convertToUSD($charge->amount, $charge->currency),
                        ...
                        'customer_account_balance' => $business->wallet(Type::AVAILABLE, $business->currency)->balance ?? 0,
                        ...
                        'counterparty_id' => $charge->customer_email ?? null,
                        'counterparty_name' => $charge->customer_name ?? null,
