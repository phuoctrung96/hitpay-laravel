...
class OrderConfirmationTemplate extends Action
{
    /**
     * @return void
    ...
    public function process(): void
    {
        ...
        $notification = new \App\Notifications\Business\EmailTemplates\OrderConfirmationTemplate($this->business, $emailTemplateDataConverted);
    ...
    private function validateEmailTemplateData(): void
    {
        ...
        $rules['store_information_title'] = 'required|string';
        $rules['store_information_value'] = 'required|string';
