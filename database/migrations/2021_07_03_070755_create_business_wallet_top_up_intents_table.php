...
class CreateBusinessWalletTopUpIntentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('business_wallet_top_up_intents', function (Blueprint $table) {
            $table->uuid('id')->primary();
            $table->uuid('business_id');
            $table->uuid('business_wallet_id')->nullable();
    ...
    {
        Schema::dropIfExists('business_wallet_top_up_intents');
    }
}
