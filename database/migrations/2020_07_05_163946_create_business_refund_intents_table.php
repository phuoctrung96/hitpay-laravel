...
class CreateBusinessRefundIntentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('business_refund_intents', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('business_refund_intents');
    }
}
